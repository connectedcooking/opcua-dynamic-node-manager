...
import com.connectedcooking.opcua.dynamicnodemanager.examples.prosys.opc30200.model.di.objecttypes.FailureAlarmType;
...
public abstract class FailureAlarmTypeNodeBase extends DeviceHealthDiagnosticAlarmTypeNode implements FailureAlarmType {
  ...
  public static GeneratedNodeInitializer<FailureAlarmTypeNode> getFailureAlarmTypeNodeInitializer() {
    return f_failureAlarmTypeNodeInitializer;
  }

  public static void setFailureAlarmTypeNodeInitializer(GeneratedNodeInitializer<FailureAlarmTypeNode> f_failureAlarmTypeNodeInitializerNewValue) {
    f_failureAlarmTypeNodeInitializer=f_failureAlarmTypeNodeInitializerNewValue;
  }
