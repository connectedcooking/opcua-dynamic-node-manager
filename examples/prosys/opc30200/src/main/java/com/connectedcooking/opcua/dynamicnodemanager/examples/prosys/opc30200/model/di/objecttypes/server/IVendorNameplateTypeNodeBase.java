...
import com.connectedcooking.opcua.dynamicnodemanager.examples.prosys.opc30200.model.di.objecttypes.IVendorNameplateType;
...
public abstract class IVendorNameplateTypeNodeBase extends BaseInterfaceTypeNode implements IVendorNameplateType {
  ...
  public static GeneratedNodeInitializer<IVendorNameplateTypeNode> getIVendorNameplateTypeNodeInitializer() {
    return f_iVendorNameplateTypeNodeInitializer;
  }

  public static void setIVendorNameplateTypeNodeInitializer(GeneratedNodeInitializer<IVendorNameplateTypeNode> f_iVendorNameplateTypeNodeInitializerNewValue) {
    f_iVendorNameplateTypeNodeInitializer=f_iVendorNameplateTypeNodeInitializerNewValue;
  }
  ...
  @Optional
  @Override
  public UaProperty getSoftwareReleaseDateNode() {
    QualifiedName browseName = getQualifiedName("http://opcfoundation.org/UA/DI/", "SoftwareReleaseDate");
    return getProperty(browseName);
  }

  @Optional
  @Override
  public DateTime getSoftwareReleaseDate() {
    UaVariable node = getSoftwareReleaseDateNode();
    if (node == null) {
      return null;
    }
    Object value = node.getValue().getValue().getValue();
  ...
  @Optional
  @Override
  public void setSoftwareReleaseDate(DateTime value) {
    UaVariable node = getSoftwareReleaseDateNode();
    if (node == null) {
      throw new RuntimeException("Setting SoftwareReleaseDate failed: does not exist (Optional Nodes must be configured in NodeBuilder)");
    }
    try {
      node.setValue(value);
    } catch(StatusException e) {
      throw new RuntimeException("Setting SoftwareReleaseDate failed unexpectedly", e);
    }
  }
