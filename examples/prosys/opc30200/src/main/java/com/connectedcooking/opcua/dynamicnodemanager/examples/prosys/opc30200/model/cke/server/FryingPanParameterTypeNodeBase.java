...
import com.connectedcooking.opcua.dynamicnodemanager.examples.prosys.opc30200.model.cke.FryingPanParameterType;
...
public abstract class FryingPanParameterTypeNodeBase extends KitchenDeviceParameterTypeNode implements FryingPanParameterType {
  ...
  protected FryingPanParameterTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    callAfterCreateIfExists(getActualPressurePanNode());
    ...
    GeneratedNodeInitializer<FryingPanParameterTypeNode> impl = getFryingPanParameterTypeNodeInitializer();
    if(impl != null) {
      impl.init((FryingPanParameterTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<FryingPanParameterTypeNode> getFryingPanParameterTypeNodeInitializer() {
    return f_fryingPanParameterTypeNodeInitializer;
  }

  public static void setFryingPanParameterTypeNodeInitializer(GeneratedNodeInitializer<FryingPanParameterTypeNode> f_fryingPanParameterTypeNodeInitializerNewValue) {
    f_fryingPanParameterTypeNodeInitializer=f_fryingPanParameterTypeNodeInitializerNewValue;
  }
  ...
  @Optional
  @Override
  public AnalogItemTypeNode getActualPressurePanNode() {
    QualifiedName browseName = getQualifiedName("http://opcfoundation.org/UA/CommercialKitchenEquipment/", "ActualPressurePan");
    return (AnalogItemTypeNode) getComponent(browseName);
  }

  @Optional
  @Override
  public Float getActualPressurePan() {
    UaVariable node = getActualPressurePanNode();
    if (node == null) {
      return null;
    }
    Object value = node.getValue().getValue().getValue();
  ...
  @Optional
  @Override
  public void setActualPressurePan(Float value) {
    UaVariable node = getActualPressurePanNode();
    if (node == null) {
      throw new RuntimeException("Setting ActualPressurePan failed: does not exist (Optional Nodes must be configured in NodeBuilder)");
    }
    try {
      node.setValue(value);
    } catch(StatusException e) {
      throw new RuntimeException("Setting ActualPressurePan failed unexpectedly", e);
    }
  }
  ...
  @Mandatory
  @Override
  public FryingPanModeEnumeration getProgramMode() {
    UaVariable node = getProgramModeNode();
    if (node == null) {
      throw new RuntimeException("Mandatory node ProgramMode does not exist");
    }
    Variant value = node.getValue().getValue();
    return (FryingPanModeEnumeration) value.asEnum(FryingPanModeEnumeration.class);
  }

  @Mandatory
  @Override
  public void setProgramMode(FryingPanModeEnumeration value) {
    UaVariable node = getProgramModeNode();
    if (node == null) {
