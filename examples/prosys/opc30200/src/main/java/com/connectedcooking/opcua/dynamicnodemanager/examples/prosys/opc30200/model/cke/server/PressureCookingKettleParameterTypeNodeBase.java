...
import com.connectedcooking.opcua.dynamicnodemanager.examples.prosys.opc30200.model.cke.PressureCookingKettleParameterType;
...
public abstract class PressureCookingKettleParameterTypeNodeBase extends KitchenDeviceParameterTypeNode implements PressureCookingKettleParameterType {
  private static GeneratedNodeInitializer<PressureCookingKettleParameterTypeNode> f_pressureCookingKettleParameterTypeNodeInitializer;

  protected PressureCookingKettleParameterTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
  ...
  public void afterCreate() {
    ...
    callAfterCreateIfExists(getActualPressureKettleNode());
    ...
    callAfterCreateIfExists(getIsOpenExpressActiveNode());
    callAfterCreateIfExists(getIsSteamActiveNode());
    ...
    GeneratedNodeInitializer<PressureCookingKettleParameterTypeNode> impl = getPressureCookingKettleParameterTypeNodeInitializer();
    if(impl != null) {
      impl.init((PressureCookingKettleParameterTypeNode)this);
    }
  }

  public static GeneratedNodeInitializer<PressureCookingKettleParameterTypeNode> getPressureCookingKettleParameterTypeNodeInitializer() {
    return f_pressureCookingKettleParameterTypeNodeInitializer;
  }

  public static void setPressureCookingKettleParameterTypeNodeInitializer(GeneratedNodeInitializer<PressureCookingKettleParameterTypeNode> f_pressureCookingKettleParameterTypeNodeInitializerNewValue) {
    f_pressureCookingKettleParameterTypeNodeInitializer=f_pressureCookingKettleParameterTypeNodeInitializerNewValue;
  }
  ...
  public Float getActualPressureAbsolute() {
    ...
    if (node == null) {
      throw new RuntimeException("Mandatory node ActualPressureAbsolute does not exist");
    }
    Object value = node.getValue().getValue().getValue();
    return (Float) value;
  }
  ...
  @Mandatory
  @Override
  public AnalogItemTypeNode getActualPressureKettleNode() {
    QualifiedName browseName = getQualifiedName("http://opcfoundation.org/UA/CommercialKitchenEquipment/", "ActualPressureKettle");
    return (AnalogItemTypeNode) getComponent(browseName);
  }

  @Mandatory
  @Override
  public Float getActualPressureKettle() {
    UaVariable node = getActualPressureKettleNode();
    if (node == null) {
      throw new RuntimeException("Mandatory node ActualPressureKettle does not exist");
    }
    Object value = node.getValue().getValue().getValue();
    return (Float) value;
  }
  ...
  @Mandatory
  @Override
  public void setActualPressureKettle(Float value) {
    UaVariable node = getActualPressureKettleNode();
    if (node == null) {
      throw new RuntimeException("Setting ActualPressureKettle failed: does not exist (Optional Nodes must be configured in NodeBuilder)");
    }
    try {
      node.setValue(value);
    } catch(StatusException e) {
      throw new RuntimeException("Setting ActualPressureKettle failed unexpectedly", e);
    }
  }
  ...
  public Boolean isIsLidLocked() {
    ...
    if (node == null) {
      throw new RuntimeException("Mandatory node IsLidLocked does not exist");
    }
    Object value = node.getValue().getValue().getValue();
  ...
  @Optional
  @Override
  public BaseDataVariableTypeNode getIsOpenExpressActiveNode() {
    QualifiedName browseName = getQualifiedName("http://opcfoundation.org/UA/CommercialKitchenEquipment/", "IsOpenExpressActive");
    return (BaseDataVariableTypeNode) getComponent(browseName);
  }

  @Optional
  @Override
  public Boolean isIsOpenExpressActive() {
    UaVariable node = getIsOpenExpressActiveNode();
    if (node == null) {
      return null;
    }
    Object value = node.getValue().getValue().getValue();
  ...
  @Optional
  @Override
  public void setIsOpenExpressActive(Boolean value) {
    UaVariable node = getIsOpenExpressActiveNode();
    if (node == null) {
      throw new RuntimeException("Setting IsOpenExpressActive failed: does not exist (Optional Nodes must be configured in NodeBuilder)");
    }
    try {
      node.setValue(value);
    } catch(StatusException e) {
      throw new RuntimeException("Setting IsOpenExpressActive failed unexpectedly", e);
    }
  }

  @Mandatory
  @Override
  public BaseDataVariableTypeNode getIsSteamActiveNode() {
    QualifiedName browseName = getQualifiedName("http://opcfoundation.org/UA/CommercialKitchenEquipment/", "IsSteamActive");
    return (BaseDataVariableTypeNode) getComponent(browseName);
  }

  @Mandatory
  @Override
  public Boolean isIsSteamActive() {
    UaVariable node = getIsSteamActiveNode();
    if (node == null) {
      throw new RuntimeException("Mandatory node IsSteamActive does not exist");
    }
    Object value = node.getValue().getValue().getValue();
    return (Boolean) value;
  }
  ...
  @Mandatory
  @Override
  public void setIsSteamActive(Boolean value) {
    UaVariable node = getIsSteamActiveNode();
    if (node == null) {
      throw new RuntimeException("Setting IsSteamActive failed: does not exist (Optional Nodes must be configured in NodeBuilder)");
    }
    try {
      node.setValue(value);
    } catch(StatusException e) {
      throw new RuntimeException("Setting IsSteamActive failed unexpectedly", e);
    }
  }
  ...
  @Mandatory
  @Override
  public PressureCookingKettleModeEnumeration getProgramMode() {
    UaVariable node = getProgramModeNode();
    if (node == null) {
      throw new RuntimeException("Mandatory node ProgramMode does not exist");
    }
    Variant value = node.getValue().getValue();
    return (PressureCookingKettleModeEnumeration) value.asEnum(PressureCookingKettleModeEnumeration.class);
  }

  @Mandatory
  @Override
  public void setProgramMode(PressureCookingKettleModeEnumeration value) {
    UaVariable node = getProgramModeNode();
    if (node == null) {
